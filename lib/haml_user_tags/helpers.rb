  ...
  module Helpers
    ...
    def self.attributes_hash(class_id, obj_ref, *attributes_hashes)
      ...
      attributes_hashes.each do |old|
        Haml::AttributeBuilder.merge_attributes!(attributes, Hash[old.map {|k, v| [k.to_s, v]}])
      end
      Haml::AttributeBuilder.merge_attributes!(attributes, Haml::AttributeBuilder.new.parse_object_ref(obj_ref)) if obj_ref
      attributes
    end
